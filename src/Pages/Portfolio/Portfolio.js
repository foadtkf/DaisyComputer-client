            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="card sm:w-full bg-base-100 shadow-xl image-full">
                ...
                <div className="card-body">
                  <h2 className="text-3xl font-bold ">{projects[0].name}</h2>
              ...
              <div className="card sm:w-full bg-base-100 shadow-xl image-full">
                ...
                <div className="card-body">
                  <h2 className="text-3xl font-bold">{projects[1].name}</h2>
                  <div className="card-actions justify-center my-auto">
                    <a
              ...
              <div className="card sm:w-full bg-base-100 shadow-xl image-full">
                ...
                <div className="card-body">
                  <h2 className="text-3xl font-bold">{projects[2].name}</h2>
                  <div className="card-actions justify-center my-auto">
                    <a
