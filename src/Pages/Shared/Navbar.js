    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <Tada>
                <a className="btn btn-ghost normal-case text-xl font-serif">Daisy Computers</a></Tada>
            </div>
            ...
            <div className="flex-none gap-2">
              <div className="dropdown dropdown-end">
                <label tabIndex="0" className="btn btn-ghost btn-circle avatar">
                  ...
                  {user?.photoURL? <img src={user?.photoURL} alt=''/> : <img src="https://www.seekpng.com/png/detail/413-4139803_unknown-profile-profile-picture-unknown.png" alt=''/>}
                  </div>
                </label>
                <ul
                  tabIndex="0"
